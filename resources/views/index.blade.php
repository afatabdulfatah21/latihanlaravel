...
<section class="blog-list px-3 py-5 p-md-5">
    <div class="container">
        @foreach ($posts as $post)
           <div class="item mb-5">
            <div class="media">
                <img class="mr-3 img-fluid post-thumb d-none d-md-flex" src="{{ asset('' . $post->featured) }}" alt="{{ $post->title }}" width="100" height="auto">
                <div class="media-body">
                    ...
                    <div class="intro">{!! substr($post->content, 0, 100) !!}</div>
        ...
        <nav class="blog-nav nav nav-justified my-5">
            @include('components.pagging',['paginator' => $posts->appends(Request::except('page'))])
        </nav>
